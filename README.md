...
* Navigate to vault->local (using FTP using [FileZilla](https://filezilla-project.org/) or SSH) and rename the config.php to offlineconfig.php; and rename onlineconfig.php to config.php.
